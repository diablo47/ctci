...
public class Q18_7 {
	...
	public static void main(String[] args){
		...
		String loggest = build(words);
		System.out.println(loggest);
	}
	
	private static String build(String[] words) {
	...
	private static boolean canBuild(String s, boolean b,
			Map<String, Boolean> dic) {
		if(dic.containsKey(s)&&!b){
			return dic.get(s);
		}
		for(int i = 1;i<s.length();i++){
			String newWord = s.substring(0,i);
			if(dic.get(newWord)!=null && dic.get(newWord)==true){
				return canBuild(s.substring(i), false, dic);
			}
		}
		dic.put(s,false);
		return false;
